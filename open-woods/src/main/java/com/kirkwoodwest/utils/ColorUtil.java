...
public class ColorUtil {
	...
	public static float getDistance(float r1, float g1, float b1, float r2, float g2, float b2) {
		...
		return (java.lang.Math.abs(r1 - r2) * 0.2989F) + (java.lang.Math.abs(g1 - g2) * 0.5870F) + (java.lang.Math.abs(b1 - b2) * 0.1140F);
	}
	...
	public static double getDistance(double r1, double g1, double b1, double r2, double g2, double b2) {
		...
		return (java.lang.Math.abs(r1 - r2) * 0.2989) + (java.lang.Math.abs(g1 - g2) * 0.5870) + (java.lang.Math.abs(b1 - b2) * 0.1140);
	}
	...
	static public int getIndexFromColor(Color color, List<Color> map) {
		...
		for (int i = 0; i < size; i++) {
			...
			double new_distance = com.kirkwoodwest.utils.ColorUtil.getDistance(color, mappedColor);
