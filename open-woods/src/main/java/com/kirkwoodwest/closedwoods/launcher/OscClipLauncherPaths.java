...
public class OscClipLauncherPaths {
  ...
  private String getTrack(int i) {
    return basePath + LAUNCHER_BASE +  "/" + (i + 1);
  }
  ...
  public String getScrollPosition(int trackIndex) {
    return getTrack(trackIndex) + "/scroll";
  }
  ...
  public String getTrackName(int trackIndex) {
    return getTrack(trackIndex) + "/name";

  }

  public String getTrackColor(int trackIndex) {
    return getTrack(trackIndex) + "/color";
  }
  ...
  public String getClipIndex() {
    return basePath + LAUNCHER_BASE + "/1/*";
  }
}
